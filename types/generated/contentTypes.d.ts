...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    season: Attribute.Enumeration<
      ['Spring/Summer', 'Autumn/Winter', 'Resort', 'Pre-Fall']
    >;
...
export interface ApiOutfitOutfit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.CustomField<
        'plugin::field-nanoid.nanoid',
        {
          idLength: 13;
        }
      >;
    where: Attribute.String;
    while: Attribute.String;
    dateWorn: Attribute.Date;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    components: Attribute.DynamicZone<['brands.brand-list']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPersonPerson extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.String;
    type: Attribute.Enumeration<['Celebrity', 'Influencer', 'Model', 'Normie']>;
    image: Attribute.Media;
    outfits: Attribute.Relation<
      'api::person.person',
      'oneToMany',
...
export interface ApiSimilarSimilar extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::outfit.outfit': ApiOutfitOutfit;
      'api::page.page': ApiPagePage;
      'api::person.person': ApiPersonPerson;
      'api::similar.similar': ApiSimilarSimilar;
